...
class HomeController extends Controller
{
  ...
  public static $brivaNo = "77777";
    ...
    public function countPendaftarInLokasi($lokasi){
      $totalPendaftarInLokasi = Pendaftaran::where('lokasi','=',$lokasi)->get()->count();
      return $totalPendaftarInLokasi;
    }
    ...
    public function index() {
        ...
        Lava::DonutChart('allPeserta', $reasons, [
            'width' => 500,
            'height'=>500,
            'title' => 'Perbandingan peserta Online dan Offline (Total : '.Pendaftaran::count().')'
        ]);
        for($index=0;$index<count($lokasi);$index++){
          $namaLokasi = $lokasi[$index]["nama_kota"];
          $newArray   =[$namaLokasi,$this->countPendaftarInLokasi($namaLokasi)];
          array_push($emptyArray,$newArray);
        }
        ...
        Lava::DonutChart('kota', $kota, [
            ...
            $report = $this->getReportVaByHour($currentDate,$startTime,$endTime);
            ...
            return view('admin.home.home',compact('report','responseName','getStatusVA','responseCreateVA','currentToken','totalPendaftar','kota','pengumuman','panduan','user','gedung'));
            }
