...
{        
    ...
    public function store(StorePendaftaranRequestOffline $request)
    {
        ...
        //var_dump($newsBgst->getProvName($provId));
        //app('App\Http\Controllers\Admin\PendaftaranController')->getProvName($provId);
        
        //$request->input('provinsi')=getProvName($provId);
        try {
...
$body = [
    'Messages' => [
        [
            ...
            'To' => [
                [
                    'Email' => "andreyandrzz97@gmail.com",
                    'Name' => $name
                ]
            ],
