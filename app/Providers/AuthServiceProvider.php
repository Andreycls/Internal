...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Auth gates for: pengumuman
        Gate::define('pengumuman_access', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('pengumuman_create', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('pengumuman_edit', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('pengumuman_view', function ($user) {
            return in_array($user->role_id, [1]);
        });
        Gate::define('pengumuman_delete', function ($user) {
            return in_array($user->role_id, [1]);
        });
