...
fill:"#fff","fill-rule":"nonzero"}}]}]}]};var e="Buka halaman video";g.R(a.P().experiments,"kevlar_miniplayer_expand_top")&&(c="ytp-miniplayer-button-top-left",d=g.X?{D:"div",W:["ytp-icon","ytp-icon-expand-miniplayer"]}:{D:"svg",N:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},K:[{D:"g",N:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},K:[{D:"g",N:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},K:[{D:"path",N:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Luaskan");g.V.call(this,{D:"button",W:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],N:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},K:[d]});this.u=a;this.ha("click",this.w,this);this.ia("title",g.SM(a,e,"i"));g.ie(this,g.cN(b.Xa(),this.element))},P5=function(a){g.V.call(this,{D:"div",
I:"ytp-miniplayer-ui"});this.player=a;this.H=!1;this.G=this.B=this.u=void 0;this.L(a,"minimized",this.lH);this.L(a,"onStateChange",this.TN)},Q5=function(a){g.AP.call(this,a);
...
g.h.show=function(){this.u=new g.Wm(this.kH,null,this);this.u.start();if(!this.H){this.C=new g.TQ(this.player,this);g.C(this,this.C);g.JL(this.player,this.C.element,4);this.C.B=.6;this.T=new g.UP(this.player);g.C(this,this.T);this.w=new g.V({D:"div",I:"ytp-miniplayer-scrim"});g.C(this,this.w);this.w.ba(this.element);this.L(this.w.element,"click",this.Xz);var a=new g.V({D:"button",W:["ytp-miniplayer-close-button","ytp-button"],N:{"aria-label":"Tutup"},K:[g.lM()]});g.C(this,a);a.ba(this.w.element);
this.L(a.element,"click",this.vy);a=new O5(this.player,this);g.C(this,a);a.ba(this.w.element);this.A=new g.V({D:"div",I:"ytp-miniplayer-controls"});g.C(this,this.A);this.A.ba(this.w.element);this.L(this.A.element,"click",this.Xz);var b=new g.V({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,b);b.ba(this.A.element);a=new g.V({D:"div",I:"ytp-miniplayer-play-button-container"});g.C(this,a);a.ba(this.A.element);var c=new g.V({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,c);c.ba(this.A.element);
...
"ytp-button"],N:{"aria-label":"Tutup"},K:[g.lM()]});g.C(this,a);a.ba(this.F.element);this.L(a.element,"click",this.vy);a=new g.V({D:"button",W:["ytp-miniplayer-replay-button","ytp-button"],N:{"aria-label":"Tutup"},K:[g.zM()]});g.C(this,a);a.ba(this.F.element);this.L(a.element,"click",this.PL);this.L(this.player,"presentingplayerstatechange",this.mH);this.L(this.player,"appresize",this.Xr);this.L(this.player,"fullscreentoggled",this.Xr);this.Xr();this.H=!0}0!=this.player.getPlayerState()&&g.V.prototype.show.call(this);
...
g.h.vy=function(){this.player.stopVideo();this.player.ma("onCloseMiniplayer")};
g.h.PL=function(){this.player.playVideo()};
g.h.Xz=function(a){if(a.target==this.w.element||a.target==this.A.element)g.R(this.player.P().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.GD(g.rL(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.ma("onExpandMiniplayer")};
g.h.lH=function(){g.L(g.pL(this.player),"ytp-player-minimized",this.player.app.H.o)};
g.h.kH=function(){g.VN(this.B);this.G.w();this.u&&this.u.start()};
g.h.mH=function(a){g.W(a.state,32)&&this.C.hide()};
g.h.Xr=function(){var a=this.B,b=g.oL(this.player).getPlayerSize().width;a.Aa=0;a.B=b;a.F=!1;g.XN(a)};
