...
return [
	...
	'pendaftar' => [
		'title' => 'Pendaftar',
		'fields' => [
			'pendaftaranOffline'=>'Pendaftaran Offline',
			'daftarOffline' => 'List Offline',
			'daftarOnline' => 'List Online',
	...
	'jadwal' => [
		...
		'fields' => [
			'index'=>'#',
			'kota'=>'Kota yang dibuka :',
			'tahun'=>'Tahun',
			'periode'=>'Periode Pendaftaran', 
			'periodeMulai'=>'Pembukaan Pendaftaran', 
			'periodeAkhir'=>'Penutupan Pendaftaran',
			'registrasiOnline'=>'Registrasi Online', 
			'registrasiOnlineBuka'=>'Pembukaan Registrasi Online', 
			'registrasiOnlineTutup'=>'Penutupan Registrasi Online', 
			'registrasiLangsung'=>'Registrasi Langsung', 
			'registrasiTest'=>'Registrasi Test',
			'registrasiTestIIHari1'=>'Registrasi Test tahap II Hari I', 
			'registrasiTestIIHari2'=>'Registrasi Test tahap II Hari II', 
			'registrasiFinal'=>'Registrasi Final', 
			'tesAkademik'=>'Jadwal Tes Akademik',
			'banyakRuanganUtama'=>'Banyak Ruangan Utama', 
			'tesPsikologi'=>'Tes Psikologi', 
			'tesInterview'=>'Tes Interview',
			'tesInterview1'=>'Tes Interview Hari I', 
			'tesInterview2'=>'Tes Interview Hari II', 
			'pengumumanTesAkademik'=>'Pengumuman Tes Akademik',
			'pengumumanFinal'=>'Pengumuman Final',
	...
	'pendaftaran' => [
		...
		'fields' => [
			...
			'kab'=>'Kabupaten / Kota Asal', 
			'smp'=>'SMP Asal', 
			'noHp'=>'Nomor HP',
			'namaAyah'=>'Nama Ayah', 
			'namaIbu'=>'Nama Ibu', 
			'noHPAyahIbu'=>'Nomor HP Ayah / Ibu', 
			'pekerjaanAyah'=>'Pekerjaan Ayah', 
			'pekerjaanIbu'=>'Pekerjaan Ibu',
			'pilihGambar'=>'Pas foto',
			'term'=>'Dengan ini saya menyatakan bahwa data ini telah saya isi dengan benar dan lengkap',		
			'laki'=>'Laki laki',
			'wanita'=>'Perempuan',
			'lokasi'=>'Lokasi Ujian',
			'pendaftar'=>'Pendaftar',
			'alamatOT'=>'Alamat Orang Tua',
			'foto'=>'Foto'
		],
	],
	'ruangan' => [
	...
	'kota' => [
		...
		'fields' => [
			...
			'city' => 'Nama kota',
			'date'=>'Tanggal Ujian',
			'banyakRuangan'=>'Banyak Ruangan Utama',
			'created_at'=>'Tanggal dibuat',
			'updated_at'=>'Tanggal diperbarui'
		],
	],
	...
	'qa_logout' => 'Keluar',
	'qa_add_new' => 'Tambah',
	'qa_are_you_sure' => 'Apakah anda yakin ?',
	'qa_back_to_list' => 'Kembali',
	'qa_dashboard' => 'Beranda',
	'qa_delete' => 'Hapus',
	...
	'qa_roles' => 'Peran',
	'qa_role' => 'Role',
	'qa_user_management' => 'Manajemen Admin',
	'qa_users' => 'Admin',
	'qa_user' => 'User',
	'qa_name' => 'Name',
	'qa_email' => 'Email',
	...
	'qa_current_password' => 'Password Sebelumnya',
	'qa_new_password' => 'Password Baru',
	'qa_password_confirm' => 'Konfirmasi Password Baru',
	'qa_dashboard_text' => 'Selamat datang, ',
	...
	'qa_there_were_problems_with_input' => 'Terdapat kesalahan saat input',
	'qa_whoops' => 'Whoops!',
	...
	'quickadmin_title' => 'SPSB Yayasan Soposurung',
	//'quickadmin_title' => 'XXX',
	'qa',
	'qa_beranda'=>'url("beranda")',
